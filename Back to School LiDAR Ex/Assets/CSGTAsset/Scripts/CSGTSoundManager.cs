...
public class CSGTSoundManager : MonoBehaviour {

    public static CSGTSoundManager instance = null;

    public AudioSource efxSource;
    public AudioSource musicSource;

    public CSGTSpriteToggle[] Buttons;
    ...
    public void SetSoundOnOff(bool off)
    {
        ...
        foreach (CSGTSpriteToggle buttonToggle in Buttons)
